              ...
              <div className="bg-white p-10 rounded-xl sticky top-32"
                ...
                <div className="text-center">
                  ...
                  <p className="font-[Manrope] text-sm text-[#586064] leading-relaxed mb-8">
                    {lang === 'id'
                      ? 'Beautifulnesia adalah platform perjalanan independen yang menghadirkan panduan jujur tentang keindahan Indonesia.'
                      : 'Beautifulnesia is an independent travel platform delivering honest guides to the beauty of Indonesia.'}
                  </p>
